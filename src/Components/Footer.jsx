...
const Footer = () => {
 return (
  <div>
    <footer className="footer footer-center p-10 bg-violet-200 text-Black-content">
  <aside>
    ...
    Embrace innovation, shop with confidence, and step into a future powered by TechnoLiz.
    </p> 
